...
function Edit()
{
    ...
    const mailingThanaSelect =  async (name) => {
        try {
            ...
            setValue('m_police_station', response.data.m_police_station);
        } catch (error) {
            console.error(error);
        }
    };
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        value = {result?.personaldata?.pr_district || ''}
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        {...register("pm_district")}
                                         value = {result?.personaldata?.pm_district || ''}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <select
                                        className="form-select text-white-dark"
                                        {...register("m_district")}
                                         value = {result?.personaldata?.m_district || ''}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <select
                                        ...
                                        value={result?.professionaldata?.department_id || ''}
                                    >
                                        <option value="">Choose Option...</option>
                                        {department.map((item) => (
                                            <option
                                ...
                                <div>
                                    ...
                                    <select
                                        className="form-select text-white-dark"
                                        {...register("section_id")}
                                        value={result?.professionaldata?.section_id || ''}
                                    >
                                        <option value="">Choose Option...</option>
                                        {section.map((item) => (
                                            <option
